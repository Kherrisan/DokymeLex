...
public class DokymeLexer {
	...
	private void stateFunction_0(byte ch) throws IOException {
		...
		else if(ch=='0') {state = 11;}
		else if(ch=='1') {state = 12;}
		else if(ch=='2') {state = 13;}
		else if(ch=='3') {state = 14;}
		else if(ch=='4') {state = 15;}
		else if(ch=='5') {state = 16;}
		else if(ch=='6') {state = 17;}
		else if(ch=='7') {state = 18;}
		else if(ch=='8') {state = 19;}
		else if(ch=='9') {state = 20;}
		else if(ch=='<') {state = 21;}
		else if(ch=='=') {state = 22;}
		else if(ch=='>') {state = 23;}
		else if(ch==']') {state = 24;}
		else if(ch=='a') {state = 25;}
		else if(ch=='b') {state = 26;}
		else if(ch=='c') {state = 27;}
		else if(ch=='d') {state = 28;}
		else if(ch=='e') {state = 29;}
		else if(ch=='f') {state = 30;}
		else if(ch=='g') {state = 31;}
		else if(ch=='h') {state = 32;}
		else if(ch=='i') {state = 33;}
		else if(ch=='j') {state = 34;}
		else if(ch=='k') {state = 35;}
		else if(ch=='l') {state = 36;}
		else if(ch=='m') {state = 37;}
		else if(ch=='n') {state = 38;}
		else if(ch=='o') {state = 39;}
		else if(ch=='p') {state = 40;}
		else if(ch=='q') {state = 41;}
		else if(ch=='r') {state = 42;}
		else if(ch=='s') {state = 43;}
		else if(ch=='t') {state = 44;}
		else if(ch=='u') {state = 45;}
		else if(ch=='v') {state = 46;}
		else if(ch=='w') {state = 47;}
		else if(ch=='x') {state = 48;}
		else if(ch=='y') {state = 49;}
		else if(ch=='z') {state = 50;}
		else if(ch=='{') {state = 51;}
		else if(ch=='}') {state = 52;}
		else {
	...
	private void stateFunction_5(byte ch) throws IOException {
		...
		end = i;lastEndState = 5;
		if(ch==')') {state = 59;}
		else if(ch==',') {state = 60;}
		else if(ch=='.') {state = 61;}
		else if(ch=='0') {state = 62;}
		else if(ch=='1') {state = 63;}
		else if(ch=='2') {state = 64;}
		else if(ch=='3') {state = 65;}
		else if(ch=='4') {state = 66;}
		else if(ch=='5') {state = 67;}
		else if(ch=='6') {state = 68;}
		else if(ch=='7') {state = 69;}
		else if(ch=='8') {state = 70;}
		else if(ch=='9') {state = 71;}
		else if(ch==':') {state = 72;}
		else if(ch==';') {state = 73;}
		else if(ch=='?') {state = 74;}
		else if(ch=='@') {state = 75;}
		...
		else if(ch=='_') {state = 78;}
		else if(ch=='a') {state = 79;}
		else if(ch=='b') {state = 80;}
		else if(ch=='c') {state = 81;}
		else if(ch=='d') {state = 82;}
		else if(ch=='e') {state = 83;}
		else if(ch=='f') {state = 84;}
		else if(ch=='g') {state = 85;}
		else if(ch=='h') {state = 86;}
		else if(ch=='i') {state = 87;}
		else if(ch=='j') {state = 88;}
		else if(ch=='k') {state = 89;}
		else if(ch=='l') {state = 90;}
		else if(ch=='m') {state = 91;}
		else if(ch=='n') {state = 92;}
		else if(ch=='o') {state = 93;}
		else if(ch=='p') {state = 94;}
		else if(ch=='q') {state = 95;}
		else if(ch=='r') {state = 96;}
		else if(ch=='s') {state = 97;}
		else if(ch=='t') {state = 98;}
		else if(ch=='u') {state = 99;}
		else if(ch=='v') {state = 100;}
		else if(ch=='w') {state = 101;}
		else if(ch=='x') {state = 102;}
		else if(ch=='y') {state = 103;}
		else if(ch=='z') {state = 104;}
		else if(ch=='{') {state = 105;}
		else if(ch=='}') {state = 106;}
		else if(ch=='!') {state = 54;}
		else if(ch=='#') {state = 55;}
		else if(ch=='$') {state = 56;}
		else if(ch=='%') {state = 57;}
	...
	private void stateFunction_25(byte ch) throws IOException {
		...
		if(ch=='0') {state = 111;}
		else if(ch=='1') {state = 112;}
		else if(ch=='2') {state = 113;}
		else if(ch=='3') {state = 114;}
		else if(ch=='4') {state = 115;}
		else if(ch=='5') {state = 116;}
		else if(ch=='6') {state = 117;}
		else if(ch=='7') {state = 118;}
		else if(ch=='8') {state = 119;}
		else if(ch=='9') {state = 120;}
		else if(ch=='a') {state = 121;}
		else if(ch=='b') {state = 122;}
		else if(ch=='c') {state = 123;}
		else if(ch=='d') {state = 124;}
		else if(ch=='e') {state = 125;}
		else if(ch=='f') {state = 126;}
		else if(ch=='g') {state = 127;}
		else if(ch=='h') {state = 128;}
		else if(ch=='i') {state = 129;}
		else if(ch=='j') {state = 130;}
		else if(ch=='k') {state = 131;}
		else if(ch=='l') {state = 132;}
		else if(ch=='m') {state = 133;}
		else if(ch=='n') {state = 134;}
		else if(ch=='o') {state = 135;}
		else if(ch=='p') {state = 136;}
		else if(ch=='q') {state = 137;}
		else if(ch=='r') {state = 138;}
		else if(ch=='s') {state = 139;}
		else if(ch=='t') {state = 140;}
		else if(ch=='u') {state = 141;}
		else if(ch=='v') {state = 142;}
		else if(ch=='w') {state = 143;}
		else if(ch=='x') {state = 144;}
		else if(ch=='y') {state = 145;}
		else if(ch=='z') {state = 146;}
		else {
			if(start == end) {tokenBuffer.remove(0);start++;return;}
			type = endState(lastEndState);outputToken();
			if(reachEnd) {i = end;} else {i = end - 1;}
	...
	private void stateFunction_26(byte ch) throws IOException {
		...
		else if(ch=='o') {state = 147;}
		else if(ch=='p') {state = 136;}
		else if(ch=='q') {state = 137;}
		else if(ch=='r') {state = 148;}
		else if(ch=='s') {state = 139;}
		else if(ch=='t') {state = 140;}
		else if(ch=='u') {state = 141;}
		else if(ch=='v') {state = 142;}
	...
	private void stateFunction_30(byte ch) throws IOException {
		...
		else if(ch=='l') {state = 152;}
		else if(ch=='m') {state = 133;}
		else if(ch=='n') {state = 134;}
		else if(ch=='o') {state = 153;}
		else if(ch=='p') {state = 136;}
		else if(ch=='q') {state = 137;}
		else if(ch=='r') {state = 138;}
		else if(ch=='s') {state = 139;}
	...
	private void stateFunction_159(byte ch) throws IOException {
		...
		if(ch=='s') {state = 191;}
		else if(ch=='t') {state = 192;}
		else if(ch=='u') {state = 193;}
		else if(ch=='v') {state = 194;}
		else if(ch=='w') {state = 195;}
		else if(ch=='x') {state = 196;}
		else if(ch=='y') {state = 197;}
		else if(ch=='z') {state = 198;}
		else if(ch=='0') {state = 111;}
		else if(ch=='1') {state = 112;}
		else if(ch=='2') {state = 113;}
		else if(ch=='3') {state = 114;}
		...
		else if(ch=='a') {state = 173;}
		else if(ch=='b') {state = 174;}
		else if(ch=='c') {state = 175;}
		else if(ch=='d') {state = 176;}
		else if(ch=='e') {state = 177;}
		else if(ch=='f') {state = 178;}
		else if(ch=='g') {state = 179;}
		else if(ch=='h') {state = 180;}
		else if(ch=='i') {state = 181;}
		else if(ch=='j') {state = 182;}
		else if(ch=='k') {state = 183;}
		else if(ch=='l') {state = 184;}
		else if(ch=='m') {state = 185;}
		else if(ch=='n') {state = 186;}
		else if(ch=='o') {state = 187;}
		else if(ch=='p') {state = 188;}
		else if(ch=='q') {state = 189;}
		else if(ch=='r') {state = 190;}
		else {
			if(start == end) {tokenBuffer.remove(0);start++;return;}
			type = endState(lastEndState);outputToken();
			if(reachEnd) {i = end;} else {i = end - 1;}
	...
	private void stateFunction_173(byte ch) throws IOException {
		...
		if(ch=='0') {state = 209;}
		else if(ch=='1') {state = 210;}
		else if(ch=='2') {state = 211;}
		else if(ch=='3') {state = 212;}
		else if(ch=='4') {state = 213;}
		else if(ch=='5') {state = 214;}
		else if(ch=='6') {state = 215;}
		else if(ch=='7') {state = 216;}
		else if(ch=='8') {state = 217;}
		else if(ch=='9') {state = 218;}
		else if(ch=='a') {state = 219;}
		else if(ch=='b') {state = 220;}
		else if(ch=='c') {state = 221;}
		else if(ch=='d') {state = 222;}
		else if(ch=='e') {state = 223;}
		else if(ch=='f') {state = 224;}
		else if(ch=='g') {state = 225;}
		else if(ch=='h') {state = 226;}
		else if(ch=='i') {state = 227;}
		else if(ch=='j') {state = 228;}
		else if(ch=='k') {state = 229;}
		else if(ch=='l') {state = 230;}
		else if(ch=='m') {state = 231;}
		else if(ch=='n') {state = 232;}
		else if(ch=='o') {state = 233;}
		else if(ch=='p') {state = 234;}
		else if(ch=='q') {state = 235;}
		else if(ch=='r') {state = 236;}
		else if(ch=='s') {state = 237;}
		else if(ch=='t') {state = 238;}
		else if(ch=='u') {state = 239;}
		else if(ch=='v') {state = 240;}
		else if(ch=='w') {state = 241;}
		else if(ch=='x') {state = 242;}
		else if(ch=='y') {state = 243;}
		else if(ch=='z') {state = 244;}
		else {
			if(start == end) {tokenBuffer.remove(0);start++;return;}
			type = endState(lastEndState);outputToken();
			if(reachEnd) {i = end;} else {i = end - 1;}
	...
	private void stateFunction_253(byte ch) throws IOException {
		if(debug) {System.out.println("[DEBUG] Enter state:" + 253);}
		end = i;lastEndState = 253;
		if(ch=='t') {state = 140;}
		else if(ch=='u') {state = 141;}
		else if(ch=='v') {state = 142;}
		else if(ch=='w') {state = 143;}
    ...
    private String endState(int state) {
		...
		if(state==2){return "BLANK";}
		if(state==3){return "BLANK";}
		if(state==4){return "NOT";}
		if(state==5){return "QUO";}
		if(state==6){return "MOD";}
		if(state==8){return "RPTH";}
		if(state==9){return "DOT";}
		if(state==10){return "DIV";}
		...
		if(state==19){return "CONSTANT";}
		if(state==20){return "CONSTANT";}
		if(state==21){return "ST";}
		if(state==22){return "ASN";}
		if(state==23){return "BT";}
		if(state==24){return "RBRCKT";}
		...
		if(state==49){return "ID";}
		if(state==50){return "ID";}
		if(state==51){return "LBRCE";}
		if(state==52){return "RBRCE";}
		if(state==53){return "CRLF";}
		if(state==107){return "MODA";}
		if(state==108){return "AND";}
		if(state==109){return "DIVA";}
		if(state==110){return "EQU";}
		...
		if(state==159){return "ID";}
		if(state==160){return "ID";}
		if(state==161){return "CONSTANT";}
		...
		if(state==168){return "FOR";}
		if(state==169){return "INT";}
		if(state==170){return "ID";}
		if(state==171){return "ID";}
		if(state==172){return "ID";}
		if(state==173){return "VOID";}
		if(state==174){return "VOID";}
		if(state==175){return "VOID";}
		if(state==176){return "VOID";}
		if(state==177){return "VOID";}
		if(state==178){return "VOID";}
		if(state==179){return "VOID";}
		if(state==180){return "VOID";}
		if(state==181){return "VOID";}
		if(state==182){return "VOID";}
		if(state==183){return "VOID";}
		if(state==184){return "VOID";}
		if(state==185){return "VOID";}
		if(state==186){return "VOID";}
		if(state==187){return "VOID";}
		if(state==188){return "VOID";}
		if(state==189){return "VOID";}
		if(state==190){return "VOID";}
		if(state==191){return "VOID";}
		if(state==192){return "VOID";}
		if(state==193){return "VOID";}
		if(state==194){return "VOID";}
		if(state==195){return "VOID";}
		if(state==196){return "VOID";}
		if(state==197){return "VOID";}
		if(state==198){return "VOID";}
		if(state==199){return "ID";}
		if(state==200){return "BOOL";}
		if(state==201){return "ID";}
		if(state==202){return "ID";}
		if(state==203){return "CHAR";}
		if(state==204){return "ID";}
		if(state==205){return "ID";}
		if(state==206){return "ID";}
		if(state==207){return "ID";}
		if(state==208){return "ID";}
		if(state==209){return "VOID";}
		if(state==210){return "VOID";}
		if(state==211){return "VOID";}
		if(state==212){return "VOID";}
		if(state==213){return "VOID";}
		if(state==214){return "VOID";}
		if(state==215){return "VOID";}
		if(state==216){return "VOID";}
		if(state==217){return "VOID";}
		if(state==218){return "VOID";}
		if(state==219){return "VOID";}
		if(state==220){return "VOID";}
		if(state==221){return "VOID";}
		if(state==222){return "VOID";}
		if(state==223){return "VOID";}
		if(state==224){return "VOID";}
		if(state==225){return "VOID";}
		if(state==226){return "VOID";}
		if(state==227){return "VOID";}
		if(state==228){return "VOID";}
		if(state==229){return "VOID";}
		if(state==230){return "VOID";}
		if(state==231){return "VOID";}
		if(state==232){return "VOID";}
		if(state==233){return "VOID";}
		if(state==234){return "VOID";}
		if(state==235){return "VOID";}
		if(state==236){return "VOID";}
		if(state==237){return "VOID";}
		if(state==238){return "VOID";}
		if(state==239){return "VOID";}
		if(state==240){return "VOID";}
		if(state==241){return "VOID";}
		if(state==242){return "VOID";}
		if(state==243){return "VOID";}
		if(state==244){return "VOID";}
		if(state==245){return "ID";}
		if(state==246){return "BREAK";}
		if(state==247){return "ID";}
		if(state==248){return "ID";}
		if(state==249){return "ID";}
		if(state==250){return "ID";}
		if(state==251){return "WHILE";}
		if(state==252){return "RETURN";}
		if(state==253){return "ID";}
		if(state==254){return "ID";}
		return "NULL";
    }
